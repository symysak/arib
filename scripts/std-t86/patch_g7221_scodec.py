"""usage: patch_g7221_scodec.py <G.722.1 source dir>

STDT86_SCODEC=1: adaptive separation (ARIB STD-T86 5.6)
STDT86_SCODEC=2: adaptive multiplex dump (5.3) to $STDT86_MUX_OUT
unset: stock ITU behaviour
"""
